export default {
    ...
    "global": {
      ...
      "label": 'block mb-1 font-bold text-s dark:text-gray-300',
    ...
    'family:dropdown': {
      ...
      "inner": 'max-w-md relative flex bg-white dark:bg-neutral-700 ring-1 ring-gray-300 dark:ring-gray-600 focus-within:ring-blue-500 focus-within:ring-2 rounded mb-1 formkit-disabled:focus-within:ring-gray-300 formkit-disabled:focus-within:ring-1 [&>span:first-child]:focus-within:text-blue-500',
      "input": 'w-full px-3 py-2 ',
      "listbox": 'bg-white dark:bg-neutral-800 drop-shadow-lg rounded overflow-hidden',
      "listboxButton": 'flex w-12 self-stretch justify-center mx-auto',
      "listitem": ' py-2 pl-7 capitalize relative hover:bg-gray-300 dark:hover:bg-gray-600 data-[is-active="true"]:bg-gray-300 data-[is-active="true"]:aria-selected:bg-blue-600 aria-selected:bg-blue-600 aria-selected:text-white dark:aria-selected:bg-blue-600 dark:aria-selected:text-white dark:text-gray-200',
      "emptyMessage": 'p-2 text-gray-500 font-semibold italic',
      "loaderIcon": 'ml-auto',
      ...
      "selector": 'flex w-full justify-between items-center [&u]  p-2 dark:text-gray-200',
    ...
    'family:text': {
      "inner": 'flex items-center max-w-md bg-white dark:bg-neutral-700 ring-1 ring-gray-300 dark:ring-gray-600 focus-within:ring-blue-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-blue-500 rounded mb-1',
      "input": 'w-full px-3 py-2 border-none text-base text-gray-700 placeholder-gray-400 dark:text-gray-200',
    },
    'family:date': {
      "inner": 'flex items-center max-w-md ring-1 ring-gray-300 focus-within:ring-blue-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-blue-500 rounded mb-1',
    ...
    "select": {
      "inner": 'flex relative items-center bg-white dark:bg-neutral-700 rounded mb-1 ring-1 ring-gray-300 dark:ring-neutral-500 focus-within:ring-blue-500 focus-within:ring-2 [&>span:first-child]:focus-within:text-blue-500',
      ...
      "selectIcon": 'flex p-[3px] shrink-0 w-5 mr-2 -ml-[1.5em] h-full pointer-events-none hidden',
      "option": 'p-3 text-sm text-gray-700'
    },
    "textarea": {
      "inner": 'flex rounded mb-1 bg-white dark:bg-neutral-700 ring-1 ring-gray-300 dark:ring-gray-600 focus-within:ring-blue-500 [&>label:first-child]:focus-within:text-blue-500',
      "input": 'block w-full px-3 py-3 border-none text-base text-gray-700 dark:text-gray-200 placeholder-gray-400 focus:shadow-outline ',
    },
  
    // PRO input styles
    "autocomplete": {
      // "outer": '[&[data-multiple="true"}]:has-multiple',
      "inner": '[&>div>[data-value]]:absolute [&>div>[data-value]]:mb-0',
      "option": 'grow text-ellipsis bg-blue-300 text-red-500',
      "input" : " border-none focus:ring-0 focus:outline-none",
      "listboxButton": 'z-10 flex w-12 self-stretch justify-center mx-auto',
      "selections": 'flex mt-0 mb-2 rounded dark:bg-transparent',
      "selection": 'flex items-center pl-2 justify-between  w-full rounded bg-gray-100',
      "closeIcon": ' flex box-content w-4 px-2 grow-0 shrink-0 formkit-icon',
      "removeSelection": 'z-50 flex-col items-center justify-center  px-3 grow-0 shrink-0 formkit-icon bg-gray-100',
    },
    "datepicker": {
      "inner": 'relative',
    ...
    "taglist": {
      "outer": "w-full" ,
      "inner": "w-full",
      "input": 'px-0 py-0 w-full grow border-transparent focus:outline-none focus:border-transparent',
      ...
      "tagWrapper": 'mr-1 mb-1 focus:outline-none focus:text-white [&>div]:focus:bg-blue-500 [&>div>button]:focus:text-white',
      "tagLabel": 'pl-2 pr-1',
